(function () {
  ...
  var _code = require("./status.js").code;
  ...
  let utils = {
    ...
    parseDownloadResponse: function (response) {
      return response && response.type && response.type === "application/json" || Object.prototype.toString.call(response).indexOf("Blob") < 0 ? this.url + "?token=" : window.URL.createObjectURL(response);
    },
