    ...
    try {
      ...
      switch (source.charAt(tagStart + 1)) {
        ...
        default:
          ...
          var end = parseElementStartPart(source, tagStart, el, entityReplacer, errorHandler); //console.log('end', end)
          ...
          appendElement(el, domBuilder, parseStack); //console.log('el', el, parseStack)
      ...
      errorHandler.error('element parse error: ' + e); //console.log('element parse error: ', e)
